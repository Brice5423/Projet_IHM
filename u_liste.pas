...
type
  ...
  Tf_liste = class(TForm)
    ...
    procedure spin_numligneChange(Sender: TObject);
...
procedure Tf_liste.spin_numligneChange(Sender: TObject);
begin
  nblignesparpage := spin_numligne.Value;
end;
